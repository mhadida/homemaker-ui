...
export default function PlacePicker({
  ...
  return (
    ...
    >
      <div className="max-h-[92dvh] w-[720px] max-w-[92vw] rounded-lg border border-[var(--border)] bg-[var(--panel-bg)] p-3 shadow-xl">
        <div className="mb-2 flex items-center justify-between">
          <h2 id="place-picker-title" className="text-sm font-semibold">
            Load a place
          </h2>
          <button
            ref={cancelRef}
        ...
        <div className="relative h-[min(420px,68dvh)] w-full overflow-hidden rounded">
